...
public enum ActionModel {
	...
	QUARK(MENU_TOOLBAR, "menu.quark", "menu.quark", "ui/quark",
        ...
        OPEN_DEVICE(MENU_TOOLBAR, "debugger.process_selector", "debugger.process_selector", "ui/startDebugger",
                        Shortcut.none()),
        APK_DIFF(MENU_TOOLBAR, "menu.apk_diff", "menu.apk_diff", null,
                        Shortcut.none()),
        APK_PATCH(MENU_TOOLBAR, "menu.apk_patch", "menu.apk_patch", null,
                        Shortcut.none()),
        AI_ASSISTANT(MENU_TOOLBAR, "menu.ai_assistant", "menu.ai_assistant", null,
                        Shortcut.none()),
